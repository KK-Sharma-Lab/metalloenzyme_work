...
option_list = list(
  make_option(c("-I", "--input"), type="character", default="/home/drkksharma/SAMSA2/organism/",
              help="Input directory", metavar="character"),
  make_option(c("-O", "--out"), type="character", default="/home/drkksharma/SAMSA2/diversity_graph.png", 
...
png(file = save_filename, width=10, height=7, units='in', res=900)
