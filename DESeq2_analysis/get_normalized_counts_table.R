...
option_list = list(
  ...
  make_option(c("-O", "--out"), type="character", default="/home/drkksharma/SAMSA2/raw_normalized_count_table.tsv", 
...
write.table(normalized_counts_table, file = save_filename, append = FALSE, quote = FALSE, sep = "\t", row.names = TRUE, col.names = TRUE)
