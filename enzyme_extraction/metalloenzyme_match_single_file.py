...
enz='/path/to/metalloenzymes_list_expasy.xlsx'; #path to file having all metalloenzymes from database
...
samtsv= f"/path/to/HMP2_healthy/{x}_humann2/{x}_ecs.tsv" # in here the 'f' in the begining of the string allows the integration og variable value in string using '{}', 
output= f"/path/to/Metalloenzymes/{x}_me.xlsx" #so the input and output file address will change for each file iterations
