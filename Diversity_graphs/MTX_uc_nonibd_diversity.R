...
png("Taxonomic Beta diversity between UC and nonIBD metatranscriptomes consisting metalloenzymes (Bray-Curtis distance).png", width = 9, height = 8, units='in', res=900)
...
png("Taxonomic Beta diversity between UC and nonIBD metatranscriptomes consisting metalloenzymes (Euclidean distance).png", width = 8, height = 8, units='in', res=900)
